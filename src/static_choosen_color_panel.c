...
struct ncplane *create_static_choosen_color_panel(struct ncplane *parent, const int y, const int x, const int rows, const int cols, const uint32_t mask)
{
